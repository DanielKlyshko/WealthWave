...
protocol OutcomAddingViewProtocol: AnyObject {

}

final class OutcomAddingView: UIViewController {
    
    var presenter: OutcomAddingPresenter!
...
extension OutcomAddingView: OutcomAddingViewProtocol {
